...
namespace ISO4Net.Library.Encoders {
    ...
    /// </summary>
    public class FA_Amount : ISOAmountFieldEncoder {

        #region FA_Amount

        public FA_Amount() : base(PaddingLeft.ZERO_PADDING, PrefixNone.Instance, TranslatorASCII.Instance) { }

        public FA_Amount(int len, string name) : base(len, name, PaddingLeft.ZERO_PADDING, PrefixNone.Instance, TranslatorASCII.Instance) { }
