...
namespace ISO4Net.Library.Encoders {
    ...
    public class FA_Char : ISOStringFieldEncoder {
        ...
        public FA_Char() : base(PaddingRight.SPACE_PADDING, PrefixNone.Instance, TranslatorASCII.Instance) { }

        public FA_Char(int len, string name) : base(len, name, PaddingRight.SPACE_PADDING, PrefixNone.Instance, TranslatorASCII.Instance) { }
