...
namespace ISO4Net.Library {
    ...
    /// <summary>
    /// Interface for Binary Translator implementation
    /// </summary>
    public interface ITranslatorBinary {
        ...
        void Translate(byte[] data, byte[] buffer, int offset);
        ...
        byte[] TranslateBack(byte[] data, int offset, int length);
